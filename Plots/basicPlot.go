...
// Generate 1D potential energy surface data
func generateSoftcorePotentialSurfaceData(params map[string]interface{}) PlotDataResponse {
    // Default grid for plots
    grid, _ := gridData.NewRGrid(-50, 50, 200)
...
func GeneratePlotData(w http.ResponseWriter, r *http.Request) {
    ...
    case "Softcore":
        response = generateSoftcorePotentialSurfaceData(req.Parameters)
    default:
